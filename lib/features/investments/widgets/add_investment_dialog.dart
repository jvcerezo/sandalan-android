    ...
    return DraggableScrollableSheet(
      ...
      builder: (_, ctrl) => Container(
        ...
        child: ListView(controller: ctrl, padding: const EdgeInsets.all(20), children: [
          ...
          TextField(controller: _amountCtl, decoration: const InputDecoration(labelText: 'Amount Invested (₱)', prefixText: '₱ '),
              keyboardType: const TextInputType.numberWithOptions(decimal: true),
              inputFormatters: [FilteringTextInputFormatter.allow(RegExp(r'[\d.,]'))]),
          const SizedBox(height: 8),
          TextField(controller: _valueCtl, decoration: const InputDecoration(labelText: 'Current Value (₱)', prefixText: '₱ ', hintText: 'Optional'),
              keyboardType: const TextInputType.numberWithOptions(decimal: true),
              inputFormatters: [FilteringTextInputFormatter.allow(RegExp(r'[\d.,]'))]),
          const SizedBox(height: 8),
