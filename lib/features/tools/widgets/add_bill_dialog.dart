...
class _AddBillDialogState extends ConsumerState<AddBillDialog> {
  ...
  Future<void> _handleSave() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        showSuccessSnackBar(context, 'Bill added successfully');
      }
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    ...
    return DraggableScrollableSheet(
      initialChildSize: keyboardHeight > 0 ? 0.95 : 0.85,
      maxChildSize: 0.95,
      minChildSize: 0.3,
      expand: false,
        ...
        child: ListView(
          ...
          children: [
            ...
            TextField(
              controller: _nameCtl,
              maxLength: 100,
              decoration: _inputDecoration(cs, 'e.g. Meralco'),
            ...
            _label('Amount *'),
            const SizedBox(height: 6),
            _amountField(cs, _amountCtl, 'Amount'),
            const SizedBox(height: 12),
